...
MongoClient.connect("mongodb+srv://shaffkazi98:shaffkazi123@cluster0.ob8t8fa.mongodb.net/", (err, client) => {
    if (err) {
        console.error('Error connecting to the database:', err);
    } else {
        const db = client.db('db_cwi1');
        ...
        app.post('/collection/orders', (req, res) => {
            ...
            const ordersCollection = client.db(db_cwi1).collection('order');
